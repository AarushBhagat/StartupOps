...
export const Signup = ({ onBack, onSignup, onLogin, selectedPlan }: SignupProps) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-[10%] left-[8%] w-24 h-24 rounded-xl bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-500/20 backdrop-blur-sm z-0"
      />
      ...
      <motion.div
        ...
        className="absolute bottom-[15%] right-[10%] w-32 h-32 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-600/10 border border-purple-500/20 backdrop-blur-sm z-0"
      />
      ...
      <motion.div
        ...
        className="absolute top-[45%] right-[5%] w-20 h-20 rounded-full bg-gradient-to-br from-blue-500/10 to-cyan-600/10 border border-blue-500/20 backdrop-blur-sm z-0"
      />
      ...
      {/* Signup Form with 3D Tilt Effect */}
      <motion.div
      ...
      >
        ...
        <div className="relative bg-[#0a0e1a]/95 backdrop-blur-2xl border border-white/20 rounded-3xl p-8 md:p-12 shadow-2xl">
          ...
          {error && (
            <div className="mt-2 mb-4 p-3 rounded bg-red-500/10 border border-red-500/50 text-red-500 text-sm">
              {error}
            </div>
          )}
          ...
          {selectedPlan && (
            <motion.div
              ...
              className="inline-block px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-600/20 border border-cyan-500/30 text-cyan-400 text-sm font-medium mb-6"
            >
          ...
          >
            ...
            <button onClick={onLogin} className="text-cyan-400 hover:underline font-medium">
              Sign in
            </button>
          </motion.p>
        </div>
