    ...
    <div className="p-6 lg:p-8 max-w-[1600px] mx-auto">
        ...
        >
          {feedbackRequests.length > 0 ? (
            feedbackRequests.map((request, index) => (
              ...
              >
                {/* ... truncated for length, we don't need to change inner structure just wrap it ... */}
            ...
            <div className="text-gray-500 text-center py-12 bg-white/5 border border-white/10 rounded-2xl">
              No feedback requests generated yet.
            </div>
          )}
        </motion.div>
      )}
      ...
      {activeTab === 'review' && (
        ...
        >
          ...
          {tasksToReview.length > 0 ? tasksToReview.map((task, index) => (
            <motion.div
              key={task.id}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <div className="text-gray-500 py-8 text-center bg-white/5 border border-white/10 rounded-2xl">
